...
:: the documentation: https://docs.camunda.org/optimize/develop/technical-guide/setup/installation/
...
echo Starting Elasticsearch 7.16.2...
...
start /b "Elasticsearch" cmd /c "%BASEDIR%elasticsearch\elasticsearch-7.16.2\bin\elasticsearch.bat" >"%ELASTICSEARCH_LOG_FILE%" 2>&1
...
:: start optimize
echo.
echo Starting Optimize 3.9.0-preview-1...
